...
public class C02_PassByValue {
    public static void main(String[] args) {
        ...
        /*
         ...
         Eger method'da array veya list'in kendisi degistirilise
         oassByValue ozelligi sebebiyle Java degisen degeri degil
         Array veya list'in orjinal degerini alir

         Ancak array veya list degistirilmeden sadece icindeki elemanlar
         degistirilirse Java obje degismedigi icin (referans ayni)
