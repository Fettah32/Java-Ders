...
public class C02_Overloading {
    public static void main(String[] args) {
        /*
        Java'da olusturdugumuz method'larin isminin yaptigi islevle uyumlu olmasini isteriz
        mesela bir String'in bir bolumunu almak icin Java
        subsutring() method'lari veya
        Verilen String'deki bazi parcalari yenileri ile degistirmek icin 2 adet replace()
         method'u var
