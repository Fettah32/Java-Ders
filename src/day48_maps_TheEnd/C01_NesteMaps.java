...
public class C01_NesteMaps {
    public static void main(String[] args) {

        /*
        eger bir elementle ilgili tutacagimiz bilgiler coksa veya kompleks ise
        bu defa ic ice mp kullanmayi tercih edebiliriz

        ic ice map kullandigimizda daha fazla datayi,
        daha duzenli olarak tutma imkaniniz olur
        Ancak, bilgiye ulasmak ve manipule etmek zorlasacaktir

        Ornek olarak dun ki map'imizi map'lerden olusan bir map olarak olusturalim
        ...
        // 102 no'lu kisinin ismini yazdiralim
