...
public class If_Else_If {
    public static void main(String[] args) {
        /*
          soru-) Kullanicidan gun ismini yazmasini isteyin. Girilen isim gecerli bir gun ise gun isminin 1.,2. ve
          3. harflerini ilk harf buyuk diger ikisi kucuk olarak yazdirin,
          gun ismi gecerli degil ise "Gecerli gun ismi giriniz" yazdirin
         */
