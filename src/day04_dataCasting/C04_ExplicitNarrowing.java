...
public class C04_ExplicitNarrowing {
    public static void main(String[] args) {
        ...
        uymayacagini calistirana kadar bilemez ama Java risk almaz
        ...
        2- double bir sayiyi int'e cast etmek gibi durumlarda data kaybi yasayabilirsiniz
        3- genis kaliptan degeri dar kaliba koydugunuzda sinirlari asan durumlarda veri baskalasabilir
        (130 yazinca -126 cikmasi gibi)
         */
    }
}
