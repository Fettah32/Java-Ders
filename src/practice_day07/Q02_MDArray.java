        ...
        for (int i = 0; i < 3; i++) { // outer
            for (int j = 0; j < 3; j++) { // inner
                if (arr[i][j].contains("$")) { // $ isareti iceriyorsa
                    ...
                    // parantez icindeki replaceAll isareti ile dolar isaretlerinden kurtulduk
                    ...
                    // bu asamada 12 degeri -> data type : Double oldu, eklerken de 3.2 ile carmamizi istedigi icin carptik
                }else {
